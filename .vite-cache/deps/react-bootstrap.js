import {
  ...
  useWindow
} from "./chunk-KG3TKZR6.js";
import {
  Container_default
} from "./chunk-6ZNLJNKD.js";
import {
  FloatingLabel_default,
  FormContext_default,
  FormGroup_default
} from "./chunk-7FYLXUJF.js";
import {
  Table_default
} from "./chunk-FLGPLTS7.js";
import {
...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-Q2ECK6V6.js";
import {
  require_react_dom
} from "./chunk-TEXMIM76.js";
import {
  Button_default,
  Button_default2
} from "./chunk-N2J6FROO.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-DXD7A6KZ.js";
import {
  require_jsx_runtime
} from "./chunk-AVRFDFNF.js";
import {
  require_react
} from "./chunk-5R3PHKVY.js";
import {
  __toESM
...
function forEach(children, func) {
  ...
  React26.Children.forEach(children, (child) => {
    if (React26.isValidElement(child)) func(child, index++);
  });
}
...
var Switch = React44.forwardRef((props, ref) => (0, import_jsx_runtime48.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function useWillUnmount2(fn) {
  ...
  (0, import_react22.useEffect)(() => () => onUnmount.current(), []);
}
...
function NoopTransition({
  ...
  const child = (0, import_react24.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react25.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var Modal = (0, import_react27.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime58.jsx)(import_jsx_runtime58.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime58.jsxs)(import_jsx_runtime58.Fragment, {
...
var AbstractModalHeader = React60.forwardRef(({
  ...
  const context2 = (0, import_react28.useContext)(ModalContext_default);
...
var Modal2 = React63.forwardRef(({
  ...
  const renderBackdrop = (0, import_react29.useCallback)((backdropProps) => (0, import_jsx_runtime66.jsx)("div", {
    ...backdropProps,
...
var NavbarCollapse = React68.forwardRef(({
  ...
  const context2 = (0, import_react31.useContext)(NavbarContext_default);
...
var Offcanvas = React74.forwardRef(({
  ...
  const renderBackdrop = (0, import_react35.useCallback)((backdropProps) => (0, import_jsx_runtime77.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React75.forwardRef(({
  ...
  const context2 = (0, import_react36.useContext)(NavbarContext_default);
...
var NavDropdown = React78.forwardRef(({
  ...
  return (0, import_jsx_runtime84.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames64.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime83.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime83.jsx)(Dropdown_default.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react40.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime94.jsxs)(import_jsx_runtime93.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react42.cloneElement)(children, triggerProps), (0, import_jsx_runtime92.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var SplitButton = React95.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime105.jsxs)(Dropdown_default, {
  ref,
  ...props,
  ...
  children: [(0, import_jsx_runtime104.jsx)(Button_default2, {
    ...
    type,
    children: title
  }), (0, import_jsx_runtime104.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime104.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
function useTabPanel(_ref) {
  ...
  const context2 = (0, import_react44.useContext)(TabContext_default);
  ...
  const {
    ...
    getControlledId,
    getControllerId
  } = context2, rest = _objectWithoutPropertiesLoose6(context2, _excluded22);
...
var ToastFade = React103.forwardRef((props, ref) => (0, import_jsx_runtime114.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React105.forwardRef(({
  ...
  const context2 = (0, import_react46.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
